...
const PAYMENT_METHOD_LABEL = { credit: '신용카드', check: '체크카드' };
...
// 결제 수단(카드류)을 표시용 문자열로. 실제 PG 연동은 없고 주문 기록용.
export function formatPaymentMethod(paymentMethod) {
  return paymentMethod ? PAYMENT_METHOD_LABEL[paymentMethod] || paymentMethod : '';
}
